...
interface CustomerSignupEmailProps {
  password?: string;
  email?: string;
  name?: string;
}

export const CustomerSignupEmail = ({
  password, email, name
}: CustomerSignupEmailProps) => {
  return <Html>
    <Head />
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={secondary}>
          Hello {name}, <br />Welcome to The RxT 🎉
        </Heading>
        <Section style={codeContainer}>
          <Text style={code}>Login url: <Link href="https://rxtn.in/en/login">rxtn.in</Link></Text>
...
CustomerSignupEmail.PreviewProps = {
  password: "144833",
} as CustomerSignupEmailProps;
