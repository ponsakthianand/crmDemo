...
interface PartnerSignupEmailProps {
  password?: string;
  email?: string;
  name?: string;
}

export const PartnerSignupEmail = ({
  password, email, name
}: PartnerSignupEmailProps) => {
  return <Html>
    <Head />
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={secondary}>
          Hello {name}, <br />Welcome to The RxT Team 🎉
        </Heading>
        <Section style={codeContainer}>
          <Text style={code}>Login url: <Link href="https://partner.rxtn.in/en/login">partner.rxtn.in</Link></Text>
...
PartnerSignupEmail.PreviewProps = {
  password: "144833",
} as PartnerSignupEmailProps;

export default PartnerSignupEmail;
