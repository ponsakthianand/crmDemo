...
import { fetchCurrentTicketChatDataAPI } from "@/src/app/store/reducers/currentTicketChat";
...
export default function ChatView({ params }) {
  ...
  const { messages, sendMessage } = useWebSocket(`ws://rxtn.onrender.com/ws/${chat}/${currentUser?.data?._id}`);
